export default {
  ...
  head: {
    ...
    meta: [
        ...
        { name: 'og:title', content: '6 degrees | الدرجات الست' },
        ...
        { name: 'og:image', content: 'https://www.6degrees.com.sa/social_icon.png' },
        { name: 'og:url', content: 'https://www.6degrees.com.sa' },
        { name: 'og:site_name', content: '6 degrees | الدرجات الست' },
  
        { name: 'twitter:card', content: 'summary_large_image' },
        { name: 'twitter:title', content: '6 degrees | الدرجات الست' },
        ...
        { name: 'twitter:image', content: 'https://www.6degrees.com.sa/social_icon.png' },
        { name: 'twitter:url', content: 'https://www.6degrees.com.sa' },
        { name: 'twitter:site', content: '@6degz' },
        { name: 'twitter:creator', content: '@6degz' },
      ],
      link: [
